...
def clustering_samples(
    meta, by_tissue, s_corr_top1000, s_corr_top81, 
    s_corr_rand, s_corr_cv, s_corr_nrcv, s_img_clstrRand, 
    s_img_clstrTop, s_img_clstr81, s_img_clstrCv, s_img_clstr_nrcv):
...
def clustering_genes(
    ...
    g_img_clstrTop, g_img_clstr81, g_img_clstrCv, g_img_clstr_nrcv):
    
    corr_matices = [g_corr_top1000, g_corr_top81, g_corr_cv, g_corr_nrcv]  
    
    rand_files = sorted([f for f in g_corr_rand.iterdir() if f.is_file()])
    for path in rand_files:
        corr_matices.append(path)

    images = [g_img_clstrTop, g_img_clstr81, g_img_clstrCv, g_img_clstr_nrcv]   
...
def clustering_samples_genes(
    ...
    top81, cv_counts, nrcv_counts, rand, 
    sg_img_clstrRand, sg_img_clstrTop, 
    sg_img_clstrTop81, sg_img_clstrCv, 
    ...
    images = [sg_img_clstrTop, sg_img_clstrTop81, sg_img_clstrCv, sg_img_clstrnrCv] 
