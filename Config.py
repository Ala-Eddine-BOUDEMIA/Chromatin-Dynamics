...
### Get QC images
#### General
general_qc_imgs = [args.IgeneralNRcv]
...
### Get QC html files
#### General
general_qc_htmls = [args.PgeneralNRcv]
...
### Get the clustermaps
s_clustermaps = [args.IclstrNRcvS]
...
sg_clustermaps = [args.IclstrNRcvSG]
